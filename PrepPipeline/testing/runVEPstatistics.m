...
setupDir(11) = struct('inDir', [], 'outDir', [], 'title', []);
setupDir(1).inDir = 'N:\\ARLAnalysis\\VEPNewTrend\\VEPStandardLevel2Robust';
setupDir(1).outDir = 'N:\\ARLAnalysis\\VEPNewTrend\\VEPStandardLevel2RobustReports';
