...
%             {'style', 'text', 'string', 'Low pass frequency',...
%             'TooltipString', defaultStruct.lowPassFrequency.description}...
%             {'style', 'edit', 'string', ...
%             num2str(defaultStruct.lowPassFrequency.value),...
%             'tag', 'lowPassFrequency', 'ForegroundColor',...
%             textColorStruct.lowPassFrequency}};
