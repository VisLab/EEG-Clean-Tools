function [paramsOut] = referenceGUI(hObject, callbackdata, inputData)%#ok<INUSL>
    ...
    while(true)
        ...
        interpolationOrderValue = typeMenuPosition( ...
            defaultStruct.interpolationOrder.value, interpolationOrderMenu);
        closeOpenWindows(title);
        geometry = {[1,4], [1,4], [1,4], 1, [3,1,3,1], [3,1,3,1], ...
                    [3,1,3,1], 1, [3,1,3,1], [3,1,3,1], [3,1,3,1], 1, ...
        ...
        uilist={{'style', 'text', 'string', 'Reference channels', ...
            ...
            {'style', 'edit', 'string', ...
             num2str(defaultStruct.referenceChannels.value), 'tag', ...
            ...
            {'style', 'edit', 'string', ...
             num2str(defaultStruct.evaluationChannels.value), ...
            ...
            {'style', 'edit', 'string', ...
             num2str(defaultStruct.rereferencedChannels.value), ...
            ...
            {'style', 'text', 'string', 'Keep filtered', ...
             'TooltipString', defaultStruct.keepFiltered.description}...
            {'style', 'checkbox', 'value', keepFilteredValue, ...
             'tag', 'keepFiltered', 'ForegroundColor', ...
              textColorStruct.keepFiltered}...
            ...
            {'style', 'edit', 'string',  ...
             num2str(defaultStruct.reportingLevel.value), ...
