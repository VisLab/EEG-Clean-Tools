...
while(true)
    ...
    uilist={{'style', 'text', 'string', 'Reference channels', ...
        ...
        {'style', 'edit', 'string', ...
        num2IncStr(defaultStruct.referenceChannels.value), 'tag', ...
        ...
        {'style', 'edit', 'string', ...
        num2IncStr(defaultStruct.evaluationChannels.value), ...
        ...
        {'style', 'edit', 'string', ...
        num2IncStr(defaultStruct.rereferencedChannels.value), ...
