%% Gathers noisyStatistics from different versions of the BCI2000 data for
% comparison. The results is collated in a noisyStatistics structure.

%% Read in the file and set the necessary parameters
pop_editoptions('option_single', false, 'option_savetwofiles', false);

averageDir = 'N:\\BCI2000\\BCI2000_Average_1Hz';
originalDir = 'N:\\BCI2000\\BCI2000_1Hz';
robustDir = 'N:\\BCI2000\\BCI2000Robust_1Hz_Unfiltered'; 
outDir = 'N:\\BCI2000';
...
for k = 1:length(inNames)
    ...
    fname = [originalDir filesep inNames{k}];
...
summaryName = [outDir filesep 'BCI2000_Summary.mat'];
