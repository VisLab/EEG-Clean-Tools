...
% ess2DerivedDir = 'N:\BCIT_ESS_RESAMPLED\X1 Baseline RSVP';

% ess2Dir = 'N:\BCIT_ESS\Experiment X6 Speed Control';
% ess2File = 'studyLevel2_description.xml';
% % ess2DerivedDir = 'N:\BCIT_ESS_RESAMPLED\Experiment X6 Speed Control';
 
% ess2Dir = 'N:\BCIT_ESS\X3 Baseline Guard Duty';
% ess2File = 'studyLevel2_description.xml';
% ess2DerivedDir = 'N:\BCIT_ESS_RESAMPLED\X3 Baseline Guard Duty';
% 
% ess2Dir = 'N:\BCIT_ESS\X3 Baseline Guard Duty';
% ess2File = 'studyLevel2_description.xml';
% ess2DerivedDir = 'N:\BCIT_ESS_RESAMPLED\X3 Baseline Guard Duty';

% ess2Dir = 'N:\Experiment XC Calibration Driving';
% ess2File = 'studyLevel2_description.xml';
% ess2DerivedDir = 'N:\BCIT_ESS_RESAMPLED\Experiment XC Calibration Driving';

% ess2Dir = 'N:\BCIT_ESS\X2 RSVP Expertise';
% ess2File = 'studyLevel2_description.xml';
% ess2DerivedDir = 'N:\BCIT_ESS_RESAMPLED\X2 RSVP Expertise';

ess2Dir = 'N:\BCIT_ESS\X4 Advanced Guard Duty';
ess2File = 'studyLevel2_description.xml';
ess2DerivedDir = 'N:\BCIT_ESS_RESAMPLED\X4 Advanced Guard Duty';
