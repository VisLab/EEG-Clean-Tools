...
dataDir1 = 'N:\\ARLAnalysis\\KaggleBCIPrep\\train';
dataDir2 = 'N:\\ARLAnalysis\\KaggleBCIPrep\\test';
summaryFolder1 = 'N:\\ARLAnalysis\\KaggleBCIPrep\\trainReports';
summaryFolder2 = 'N:\\ARLAnalysis\\KaggleBCIPrep\\testReports';
...
for k = 1:length(inNames1)
    ...
    load(fname, '-mat');
    publishPrepPipelineReport(EEG, summaryFolder1, summaryReportName, ...
...
for k = 1:length(inNames2)
    ...
    sessionReportName = [thisFile '.pdf'];
    load(fname, '-mat');
    publishPrepPipelineReport(EEG, summaryFolder2, summaryReportName, ...
                  sessionFolder, sessionReportName);
end
