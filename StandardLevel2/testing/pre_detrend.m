function [data, g, fitlines] = pre_detrend(data, srate)
%
...
% This function was modified by Kay Robbins 2015, UTSA
% for inclusion in EEG-Clean-Tools.
...
g.verb = 1;
g.method = {'linear'};
g.piecewise.seglength = 0.33;  % length of detrend segment in seconds
g.piecewise.stepsize = 0.0825; % stepsize between segment centers in seconds
g.piecewise.arg_selection = true;  %false indicates global detrend
g.plot = true;
% data = g.data;
% g=rmfield(g,'data');
