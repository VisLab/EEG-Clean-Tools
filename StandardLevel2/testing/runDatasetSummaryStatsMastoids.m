...
statFiles = {...
    ...
    'N:\\ARLAnalysis\\NCTU\\Level2\\dataStatistics.mat'; ...
...
statNames = {'collectionStats'; 'collectionStats'; 'collectionStats';...
             'collectionStats'; 'collectionStats'; 'collectionStats'};
legendString = {'MR-VEP', 'MA-VEP', 'M-VEP', 'MR-LK', 'MA-LK', 'M-LK'};
markerColors =  [ ...
    1    0.75    0; ...
    0    0    1; ...
    0.2   0.9  0.2; ...
...
for k = 1:length(collections)
   plot(median(medRatios{k}), median(sdrRatios{k}), ...
    'Marker', markerShapes{k}, 'MarkerSize', 14, 'LineWidth', medianMarkWidth, ...
...
for k = 1:length(collections)
     ...
     'MarkerSize', 14, 'LineWidth', medianMarkWidth, 'MarkerEdgeColor', medianMarkColor, ...
