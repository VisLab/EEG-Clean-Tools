...
statNames = {'collectionStats'; 'collectionStats'; 'collectionStats'; ...
              'collectionStats'; 'collectionStats'; 'collectionStats'; ...
              'collectionStats'; 'collectionStats'; 'collectionStats'};
legendString = {'LK M-Robust', 'LK M-Average', 'LK M-Before', ...
...
for k = 1:length(collections)
    refRatios{k} = collections{k}.statistics(:, s.rSDWinDevRef)./ ...
...
for k = 1:length(originalIndices)
    refRatios{k + baseLength} = ...
        collections{originalIndices{k}}.statistics(:, s.rSDWinDevOrig)./ ...
        collections{originalIndices{k}}.statistics(:, s.medWinDevOrig);
end
