...
%% Specific setup
outdir = 'N:\\ARLAnalysis\\VEPTemp\\VEPStandardLevel2GlobalLocalTrend';
params.detrendType = 'high pass';
params.detrendCutoff = 0.3;
params.referenceType = 'robust';
basenameOut = [basename 'GTRev_cutoff' num2str(params.detrendCutoff)];
%% Run the pipeline
for k = 1:18
    ...
    fprintf(['Computation times (seconds): %g resampling,' ...
             '%g global detrend, %g line noise, %g detrend, %g reference \n'], ...
             computationTimes.resampling, computationTimes.globalTrend, ...
             computationTimes.lineNoise, computationTimes.detrend, computationTimes.reference);
