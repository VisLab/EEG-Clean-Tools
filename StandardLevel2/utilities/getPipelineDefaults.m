...
%
    switch lower(type)
       case 'boundary'
        ...
        case 'resample'
            defaults = struct('resampleFrequency', ...
        ...
        case 'detrend'
             ...
             defaults = struct( ...
               'lineNoiseChannels', ...
                ...
                'fPassBand', ...
                   ...
                   'Frequency band used (default [0, Fs/2] = entire band)'),  ...
                'maximumIterations', ...
                   getRules(10,  ...
                   {'numeric'}, {'positive', 'scalar'}, ...
         ...
         case 'find noisy'
             defaults = struct( ...
               ...
               'channelLocations', ...
                  getRules(signal.chanlocs, {'struct'}, ...
                   {'nonempty'}, ...
             ...
             defaults = struct( ...
                 'referenceType', ...
                  getRules('robust', {'char'}, {}, ...
                   'Type of reference: robust, average or specific.'), ...
               'referenceChannels', ...
                  getRules(1:size(signal.data, 1), {'numeric'}, ...
                   {'row', 'positive', 'integer', '<=', size(signal.data, 1)}, ...
                   'Vector of channel numbers of the channels use for reference.'), ...
                'evaluationChannels', ...
                  getRules(1:size(signal.data, 1), {'numeric'}, ...
                   {'row', 'positive', 'integer', '<=', size(signal.data, 1)}, ...
                   'Vector of channel numbers of the channels to test for noisiness.'), ...
