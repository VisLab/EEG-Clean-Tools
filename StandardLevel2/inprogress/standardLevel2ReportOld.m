...
%% Robust deviation window statistics
    ...
    showBadWindows(beforeDeviation, afterDeviationRel, beforeTimeScale, afterTimeScale, ...
        numberReferenceChannels, legendStrings, noisyParameters.name, thresholdName);
    fractionBefore = mean(beforeDeviation)/numberReferenceChannels;
    fractionAfter = mean(afterDeviation)/numberReferenceChannels;
    fractionAfterRel = mean(afterDeviationRel)/numberReferenceChannels;
...
%% Correlation window statistics
    ...
    showBadWindows(beforeCorrelation, afterCorrelation, beforeTimeScale, afterTimeScale, ...
        numberReferenceChannels, legendStrings, noisyParameters.name, thresholdName);
    fractionBefore = mean(beforeCorrelation)/numberReferenceChannels;
    fractionAfter = mean(afterCorrelation)/numberReferenceChannels;
...
%% Channels with poor ransac correlations
    ...
    showBadWindows(beforeRansac, afterRansac, beforeTimeScale, afterTimeScale, ...
        numberReferenceChannels, legendStrings, noisyParameters.name, thresholdName);
    fractionBefore = mean(beforeRansac)/numberReferenceChannels;
    fractionAfter = mean(afterRansac)/numberReferenceChannels;
...
%% HF noise window stats
    ...
    afterNoiseRel = sum(afterNoiseRel >= referenced.highFrequencyNoiseThreshold);
    ...
    fractionBefore = mean(beforeNoise)/numberReferenceChannels;
    fractionAfter = mean(afterNoise)/numberReferenceChannels;
    fractionAfterRel = mean(afterNoiseRel)/numberReferenceChannels;
