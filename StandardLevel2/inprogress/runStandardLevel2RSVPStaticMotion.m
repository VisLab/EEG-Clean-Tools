...
indir = 'E:\\CTAData\\StaticMotionRSVP'; % Input data directory used for this demo
outdir = 'N:\\ARLAnalysis\\StaticMotionRSVP';
baddir = 'N:\\ARLAnalysis\\StaticMotionRSVP';
%baddir = 'E:\\CTAData\\StaticMotionRSVP\\bad';
...
for k = 1:length(in_names)
    ...
    if strcmpi(EEG.etc.noisyParameters.errors.status, 'unprocessed')
