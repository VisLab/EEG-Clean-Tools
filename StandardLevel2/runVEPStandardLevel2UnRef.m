...
%% Specific setup
outdir = 'N:\\ARLAnalysis\\VEPTemp\\VEPStandardLevel2UnRef';
params.detrendType = 'high pass';
params.detrendCutoff = 0.3;
params.referenceType = 'robust';
basenameOut = [basename 'UnRef_cutoff' num2str(params.detrendCutoff)];
%% Run the pipeline
for k = 1:18
    ...
    [EEG, computationTimes] = standardLevel2UnRefPipeline(EEG, params);
